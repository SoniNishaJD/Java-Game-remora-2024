...
import static com.jkoolcloud.nisha.advices.MethodsAdvice.CONFIGURATION_PATH;
...
import com.jkoolcloud.nisha.advices.MethodsAdvice;

public class TKMethodsTest {

	@BeforeClass
	public static void setupENV() {
		System.setProperty("nisha.path", "..");
		System.out.println(Paths.get(System.getProperty("nisha.path")).toAbsolutePath().normalize());
