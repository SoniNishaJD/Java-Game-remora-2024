 ...
 * {@link com.jkoolcloud.nisha.advices.BaseTransformers#prepareIntercept(Class, Object, Method, Object...)} and a
 * filter implementation is supposed to decide if the implementation is supposed to be processed further.
 * <p>
 * As the advice filter is supposed to be created by {@link com.jkoolcloud.nisha.RemoraConfig} or REST endpoint on
 * nisha-config module it should have default not arguments constructor.
 * <p>
 * For a filter configuration use fields annotated with {@link com.jkoolcloud.nisha.RemoraConfig.Configurable}, so it
