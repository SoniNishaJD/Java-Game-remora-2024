...
import com.jkoolcloud.nisha.adviceListeners.AdviceListener;
import com.jkoolcloud.nisha.core.CallStack;
import com.jkoolcloud.nisha.core.EmptyStack;
 ...
 * <li>Sending {@link com.jkoolcloud.nisha.core.Entry} and {@link com.jkoolcloud.nisha.core.Exit}
...
public abstract class BaseTransformers implements RemoraAdvice, Loggable {
	...
	protected ElementMatcher<NamedElement> getClassIgnores() {
		return nameStartsWith("net.openhft") //
				...
				.or(nameStartsWith("com.jkoolcloud.nisha")) //
