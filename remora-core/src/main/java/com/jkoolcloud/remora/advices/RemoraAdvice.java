 ...
 *
 * Advice implementations are installed on {@link com.jkoolcloud.nisha.RemoraInit} using
 * {@link java.util.ServiceLoader}. The implementations of actual should be defined in file
 * META-INF/services/com.jkoolcloud.nisha.advices.RemoraAdvice witch contains a list of fully-qualified binary names of
