...
/**
 * Marks the advice that should not create {@link com.jkoolcloud.nisha.core.EntryDefinition}, instead it should poll
 * one from stack and add the required parameters. This is useful for a particular methods there is no need to create
 * {@link com.jkoolcloud.nisha.core.EntryDefinition} but to collect particular properties, i.e. CallableStatement
