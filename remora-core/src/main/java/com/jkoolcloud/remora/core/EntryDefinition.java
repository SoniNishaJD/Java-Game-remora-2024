...
import com.jkoolcloud.nisha.advices.TransparentAdvice;

/**
 * This class is supposed to store the instrumentation data eventually to be passed to the
 * {@link com.jkoolcloud.nisha.core.output.AgentOutput}.
 * <p>
...
public class EntryDefinition implements EntryDefinitionDescription {
	...
	/**
	 * Flags that the entry is already sent. This is marked by {@link com.jkoolcloud.nisha.core.output.AgentOutput} to
	 ...
	 * and shouldn't be processed by {@link com.jkoolcloud.nisha.core.output.AgentOutput}.
	 */
	 ...
	 * as it's effectively sends the entity to {@link com.jkoolcloud.nisha.core.output.AgentOutput}, and as it can be
	 ...
	 * {@link com.jkoolcloud.nisha.filters.AdviceFilter}
	 */
