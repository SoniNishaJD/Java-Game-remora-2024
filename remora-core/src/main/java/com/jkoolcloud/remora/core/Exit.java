...
import static com.jkoolcloud.nisha.core.EntryDefinition.DEFAULT_APPL_NAME;

import java.util.HashMap;
import java.util.Map;
import java.util.Objects;

import com.jkoolcloud.nisha.core.output.ChronicleOutput;
import com.jkoolcloud.nisha.core.output.ScheduledQueueErrorReporter;
...
public class Exit extends SelfDescribingMarshallable implements Runnable {
	...
	private String getApp() {
		return System.getProperty("nisha.appl.name", DEFAULT_APPL_NAME);
	}
