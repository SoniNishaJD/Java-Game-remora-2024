...
import com.jkoolcloud.nisha.core.Entry;
import com.jkoolcloud.nisha.core.EntryDefinition;
import com.jkoolcloud.nisha.core.EntryDefinitionDescription;
import com.jkoolcloud.nisha.core.Exit;
import com.jkoolcloud.nisha.testClasses.TestUtils;
...
public class ChronicleQueueTest {
	...
	public void streamTest() throws Exception {
		...
		// "com.jkoolcloud.nisha.core.EntryDefinition");
	...
	public void streamTestWithCreateQueue() throws Exception {
		...
		try (TestUtils.TempQueue queue = new TestUtils.TempQueue()) {
			...
			stream.setProperty(ChronicleQueueProperties.PROP_MARSHALL_CLASS, "com.jkoolcloud.nisha.core.Exit");
			stream.addReference(new NullActivityOutput());
	...
	public void testReadQueue() {
		ChronicleQueue queue = ChronicleQueue
				.singleBuilder("c:\\workspace\\build\\nisha\\nisha-0.1.3-SNAPSHOT\\queue\\").build();

		// .singleBuilder("c:\\workspace\\build\\nisha\\nisha-0.1.3-SNAPSHOT\\q").build();
